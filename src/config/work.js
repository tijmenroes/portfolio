...
const coostoStakeholder = "Coosto is een bedrijf gevestigd in Eindhoven, één van de producten die zij verkopen is de Coosto social media tool."
...

    {
        ...
        dialog: {  
            ...
            content: [
                ...
                { type: 'text', title: description, text: "Coosto beheert een tool om een samenwerking met hun partner soepel te laten verlopen, namelijk de DAS of het Domain Administration System. Dit is een platform waar domeinen die gespiderd worden voor data bekeken en beheerd kunnen worden. Voor mijn afstudeerstage heb ik de DAS op de schop genomen."  },
                { type: 'image', src: "das-old" },
                { type: 'text', text: "Hierboven is een screenshot te zien van de DAS, waarop een domein en de bijbehorende sub domeinen en statussen te zien zijn. De subdomeinen worden gespiderd."},
                { type: 'largeText', title: proces, text: [
                ...
                { type: 'text', text: "Het bereikte resultaat is de oplevering van een nieuw frontend en een backend dat dient als API Gateway."}
            ]
        }
    },
    {
        ...
        dialog: {
          ...
          content: [
            { type: 'text', title: stakeholder, text: "The Cre8ion.Lab is een reclamebureau uit ‘s-Hertogenbosch dat zich specialiseert in ICT, met name front-end development. " },

            { type: 'largeText', title: description, text: [
      ...
      },
      {
        ...
        dialog: {
          ...
          content: [
            { type: 'text', title: stakeholder, text: "PIDZ is een detacheringsbureau voor zorgprofessionals. Ter ondersteuning van dit proces hebben zij een platform opgericht genaamd “mijnPIDZ”. In dit platform kunnen de zorgprofessionals hun opdrachten beheren en extra administratie uitvoeren." }, 
            { type: 'text', title: description, text: "PIDZ heeft een marktonderzoek uitgevoerd, uit dit onderzoek bleek dat een uitbreiding van het bestaande platform een grote kans zou zijn. De zorgprofessionals beschikken graag over een 1-stop-shop waar zij gezamenlijk van gebruik kunnen maken om te zorgen voor extra scholing, verbinding en administratie." },
            { type: 'largeText', title: proces, text: [
      ...
      },
      {
        ...
        dialog: {
          tags: ["2019", "Vue"],
          content: [
            { type: 'text', title: stakeholder, text: "Voor mijn eerste stage heb ik een product portfolio opgeleverd waarin alle producten en documenten te zien zijn." },
            { type: 'text', title: description, text: "Ik stond voor de keuze om een ouderwetse scriptie op te leveren voor mijn stage, of een online product portfolio. Ik heb voor de portfolio gekozen. Het portfolio is gemaakt met de fonts en kleuren van het stage bedrijf, de rest was mijn eigen input." },
